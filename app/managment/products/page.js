    ...
    <>
      ...
      <div className="flex flex-col items-center w-[70%] mx-auto">
        <div className="lg:flex flex justify-between lg:justify-start w-full">
          ...
          <Link href={`/managment/products/add`} className="lg:hidden md:hidden text-white hover:bg-gray-700 border-slate-600 rounded-md p-2 text-sm bg-[#0e2439]">Nuevo</Link>
