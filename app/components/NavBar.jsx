...
const NavBar = () => {
  ...
  return (
    ...
    <Logo/>
     <div className="flex justify-center items-center h-full text-white gap-6">
       ...
       <div><Link className={`p-2 rounded-lg border border-transparent ${pathname === '/products/add' ? 'border-gray-400' : ''} hover:text-gray-400 hover:border-gray-400`} href={`/products/add`}>Agregar</Link></div>
