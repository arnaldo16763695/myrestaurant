...
const FormEditProducts = ({ params }) => {
    ...
    const editProduct = async (e) => {
        ...
        if (form.name.trim() === "" || form.price.toString().trim() === "" || form.categoryId.toString().trim() === "") {
            ...
            >
                ...
                <div className="my-4">
                    ...
                    <div className="my-4 lg:flex flex justify-between lg:justify-start">
                        <button className=" text-white hover:bg-gray-700 border-slate-600 rounded-md p-2 text-sm bg-[#0e2439]">Guardar</button>
